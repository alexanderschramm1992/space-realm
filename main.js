...
var $author$project$Main$LandingPageModel = function (a) {
	return {$: 'LandingPageModel', a: a};
};
...
var $author$project$Main$LandingPageMsg = function (a) {
	return {$: 'LandingPageMsg', a: a};
};
...
var $author$project$Main$sendLoginRequest = _Platform_outgoingPort(
	'sendLoginRequest',
	function ($) {
...
var $author$project$Main$updateLandingPage = F2(
	function (msg, model) {
		if (model.$ === 'LandingPageModel') {
			var content = model.a;
			switch (msg.$) {
				...
				case 'LoginRequested':
					return _Utils_Tuple2(
						model,
						$author$project$Main$sendLoginRequest(
							{password: content.password, username: content.username}));
				default:
					var response = msg.a;
					return A2($author$project$Main$processLoginResponse, response, model);
			}
		} else {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'LandingPageMsg') {
			var landingPageMsg = msg.a;
			return A2($author$project$Main$updateLandingPage, landingPageMsg, model);
		} else {
			var mapPageMsg = msg.a;
			return A2($author$project$Main$updateMapPage, mapPageMsg, model);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$LandingPageMsg($author$project$Main$LoginRequested))
					]),
				_List_Nil)
			]));
};
...
var $author$project$Main$landingPageView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						function () {
						if (model.$ === 'LandingPageModel') {
							return $author$project$Main$landingPageView(model);
						} else {
							return $author$project$Main$solarSystemView(model);
						}
					}()
					]))
			]),
